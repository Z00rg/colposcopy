...
export function UiProgressBar({
  ...
  return (
      <div className="relative mx-auto overflow-x-auto overflow-y-hidden custom-scrollbar max-w-[340px] bg-white border border-gray-200 rounded-xl shadow-sm">
            ...
            return (
                ...
                >
                  ...
                  <button
                      ...
                      className={clsx(
                          "relative flex w-10 h-10 flex-shrink-0 justify-center items-center cursor-pointer font-semibold text-sm transition-all duration-200 rounded-full",
                          {
