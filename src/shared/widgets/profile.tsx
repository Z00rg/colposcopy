...
export function Profile({ className }: { className?: string }) {
  ...
  return (
    <div className={clsx(className, "w-[388px] gap-4 px-[17px] py-2.5 text-[18px] flex bg-[#F3F3F3] items-center justify-start shadow-[0px_4px_4px_rgba(0,0,0,0.25)] rounded-[20px]")}>
