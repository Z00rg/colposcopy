  ...
  return (
    <AppProvider>
      ...
      >
        ...
        <div className="lg:min-h-[667px] lg:max-h-[1000px] lg:w-[600px] lg:rounded-[44px] lg:border-[3px] lg:border-black lg:shadow-xl lg:shadow-black/30 lg:overflow-auto lg:pb-[0vh] relative pb-[9vh]">
          <Component {...pageProps} />
        </div>
      </div>
    </AppProvider>
