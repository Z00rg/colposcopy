  ...
  return (
    <AppProvider>
      ...
      >
        ...
        <div className="lg:min-h-[667px] lg:max-h-[956px] lg:w-[440px] lg:rounded-[44px] lg:border-[3px] lg:border-black lg:shadow-xl lg:shadow-black/30 lg:overflow-auto relative">
          <Component {...pageProps} />
        </div>
      </div>
    </AppProvider>
